...
vector_store = DatabricksVectorSearch(
  endpoint="document_management_agent", # TODO: Fill in with your VS endpoint name
  index_name="distribution_dsc.document_management_agent.managed_vs_index", # TODO: Fill in with your VS index name
  columns=[
    "id",
    "content",
    "url",
